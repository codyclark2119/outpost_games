      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-12">
          ...
          <div class="flex items-center gap-3">
            ...
            >
            <button class="btn-secondary px-4 py-2" @click="handleLogout">Log Out</button>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
        ...
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <router-link
              to="/x/outpostAdmin/featured-items"
              class="card hover:shadow-xl transition-all duration-300"
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-pink-500 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
                  ...
                  >
                    <path
                      ...
                      stroke-linejoin="round"
                      stroke-width="2"
                      d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.539 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.784.57-1.838-.197-1.539-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"
                    />
                  </svg>
                </div>
                <h3 class="font-cinzel font-semibold text-lg mb-1">Manage Featured Items</h3>
                <p class="text-gray-500 text-sm">Edit, hide, or reorder homepage promotions</p>
              </div>
            </router-link>

            <router-link
              to="/x/outpostAdmin/featured-items/add"
              class="card hover:shadow-xl transition-all duration-300"
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-pink-600 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
                ...
                <h3 class="font-cinzel font-semibold text-lg mb-1">Add Featured Item</h3>
                <p class="text-gray-500 text-sm">Promote a new item on the homepage</p>
              </div>
            </router-link>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            >
              <div class="text-center">
                ...
                >
                  <svg
                    class="w-7 h-7 text-outpost-gold"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h3 class="font-cinzel font-semibold text-lg mb-1">Manage Products</h3>
                <p class="text-gray-500 text-sm">Edit visibility, prices, and descriptions</p>
              </div>
            </router-link>
            ...
            >
              <div class="text-center">
                ...
                >
                  <svg
                    class="w-7 h-7 text-outpost-black"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h3 class="font-cinzel font-semibold text-lg mb-1">Add Products</h3>
                <p class="text-gray-500 text-sm">Add new game types, sets, or products</p>
              </div>
            </router-link>
          </div>
        </div>
        ...
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-purple-700 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
        ...
        <div class="mb-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-emerald-700 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
            ...
            >
              <div class="text-center">
                <div
                  class="w-14 h-14 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-3"
                >
                  <svg
                    class="w-7 h-7 text-white"
                    fill="none"
